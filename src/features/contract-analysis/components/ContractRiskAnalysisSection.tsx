import { Box, Typography, List, ListItem, Chip, Grid } from "@mui/material";
import { ContractRiskAnalysisResult } from "../types/contractAnalysis.types";
import { SectionCard } from "../../../shared/ui/SectionCard/SectionCard";
import { RiskSeverityBadge } from "./ContractRiskSeverityBadge";
...
export function RiskAnalysisSection({
  riskAnalysis,
}: RiskAnalysisSectionProps): JSX.Element {
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
      <Grid container spacing={2}>
        <Grid item xs={12} sm={4}>
          <SectionCard sectionTitle="Overall Risk Level">
        ...
        <Grid item xs={12} sm={4}>
          <SectionCard sectionTitle="High Severity">
        ...
        <Grid item xs={12} sm={4}>
          <SectionCard sectionTitle="Medium Severity">
      ...
      <SectionCard sectionTitle="Risk Analysis Summary">
        <Typography variant="body1" color="text.primary">
          {riskAnalysis.riskAnalysisSummary}
        </Typography>
      </SectionCard>

      <SectionCard sectionTitle={`Risk Flags (${riskAnalysis.riskFlags.length})`}>
            ...
            {riskAnalysis.riskFlags.map((riskFlag, index) => (
              <ListItem
                ...
                sx={{
                  px: 0,
                  borderBottom:
                    index < riskAnalysis.riskFlags.length - 1
                      ? "1px solid"
                      : "none",
                  borderColor: "divider",
